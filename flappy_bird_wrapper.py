...
class GameState:
    ...
    def check_score(self):
        """
        Check if the player scored a point
        :return: The reward for the player scoring a point
        """
    ...
    def frame_step(self, input_action):
        """
        Make a move for a given frame in FP
        :param input_action: A binary value for jumping or not
        :return:
        """
        pygame.event.pump()
